...
export const BottomNavigation: React.FC<BottomNavigationProps> = ({
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-30 bg-[#131F24]/95 backdrop-blur border-t border-[#2A373F] px-1 py-1 safe-bottom">
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`relative flex flex-col items-center justify-center py-1 px-1.5 rounded-xl transition-all duration-200 min-w-[50px] ${
                isActive
            ...
            >
              ...
              <span className="text-[10px] tracking-tight mt-0.5 truncate max-w-[55px]">{tab.label}</span>
              {isActive && (
